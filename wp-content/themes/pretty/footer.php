  ...
  <div class="container inner">
    ...
    <div class="row light-wrapper">
      <div class="col-md-3 col-lg-3 row">
          <div class="section-title" style="margin-left: 30px;margin-right: 15px"> <h2><label style="font-size:18px">Bản đồ</label></h2></div>
      ...
      --><div style="margin-left: 30px" class="col-md-4 col-lg-4">
        <div class="section-title"> <h2><label style="font-size:18px">Thông tin tuyển dụng</label></h2></div>
        <?php get_template_part('content', 'product-by-tuyendung') ?>
      </div>
      <div style="margin-left: 30px" class="col-md-4 col-lg-4">
        <div class="section-title"> <h2><label style="font-size:18px">Đối tác uy tín</label></h2></div>
