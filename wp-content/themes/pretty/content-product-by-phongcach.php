    ...
    <div class="isotope items">
      <?php if ($posts): ?>
        <?php foreach ($posts as $key => $post): ?>
          <div class="item post">
            <figure style="width: 310px; height: 230px;margin-left: 20px;">
            ...
            <div class="post-content" style="width: 330px;margin-left: 20px;">
              <h3 class="post-title"><a title="<?php the_title(); ?>" href="<?php the_permalink(get_the_ID()); ?>"><?= Helpers::showTitle(get_the_title(), 15); ?></a></h3>
